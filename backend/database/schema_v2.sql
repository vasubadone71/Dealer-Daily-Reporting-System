-- Drop old transaction tables that rely on hardcoded columns
DROP TABLE IF EXISTS sales_data;
DROP TABLE IF EXISTS dispatches;
DROP TABLE IF EXISTS daily_stock_balances;
...
-- Bookings can go to reports table now since sales_data is gone
ALTER TABLE reports ADD COLUMN today_booking INTEGER DEFAULT 0;
ALTER TABLE reports ADD COLUMN total_booking INTEGER DEFAULT 0;
